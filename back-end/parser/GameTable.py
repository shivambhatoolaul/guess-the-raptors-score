...
if __name__ == "__main__":
    ...
    # gt6 = guess_the_raptors_score.get_game_table(game_number=6)
    # print(gt6)
    # print(game_table_to_html(gt6, "GAME 6: TOR 114 - 106 MIL"))

    # gt7 = guess_the_raptors_score.get_game_table(game_number=7)
    # print(gt7)
